...
public class MetricsAutoConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<MeterRegistryPostProcessor> getMeterRegistryPostProcessorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MeterRegistryPostProcessor>forFactoryMethod(MetricsAutoConfiguration.class, "meterRegistryPostProcessor", ApplicationContext.class, MetricsProperties.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
